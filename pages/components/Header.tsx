...
export function Header() {
  return (
    <header className="flex items-center px-3 h-16 border-y">
      ...
      <div className="w-7/12 flex items-center px-5 relative">
        <input
          type="search"
          name="search"
          id="search"
          placeholder="Search examples..."
          className="peer ml-2 placeholder:text-gray-500 font-medium border-b focus:outline-none h-16 focus:border-b-2 focus:border-accent-dark absolute left-0 pl-7 w-full max-w-xl"
        />
        <label htmlFor="search" className="text-gray-500 absolute left-2 z-10 cursor-text peer-focus:text-accent-dark">
          <SearchIcon height={20} />
        </label>
      </div>
      <ul className="w-3/12 flex items-center justify-end font-medium">
        <li>
